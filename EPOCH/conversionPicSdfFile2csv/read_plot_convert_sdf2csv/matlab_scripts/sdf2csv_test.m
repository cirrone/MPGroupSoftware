...
%
% Cirrone version: it read a .sdf file produced with PIC 3D simulation by 
% Dr Martina Zakova (ELI-Beamlines) and convert it in a .csv file that can
% be read by the ELIMED Geant4 application.
% This script was then modify in order to read and convert a .sdf file produced
% with 1D EPOCH examples
%
...
fileToConvert = GetDataSDF('/home/beatrice/epoch/epoch1d/Data/2fasci-carichi_concordi/0038.sdf')
...
px_R = fileToConvert.Particles.Px.Right.data;
px_L = fileToConvert.Particles.Px.Left.data;
...
x_R = fileToConvert.Particles.Px.Right.grid.x; 
x_L = fileToConvert.Particles.Px.Left.grid.x;
...
%
csvwrite_with_headers('/home/beatrice/GitHub/EPOCH/conversionPicSdfFile2csv/sdf2csv_unstable/prova.csv', M, header);

...
//****************************************
// ADDED TO CHECK OTHER PHYSICS FOR IONS
#include "G4IonElasticPhysics.hh"  //SF
#include "G4IonPhysicsPHP.hh"  //SF
//****************************************
#include "G4DecayPhysics.hh"
...
void HadrontherapyPhysicsList::AddPhysicsList(const G4String& name)
{
    ...
    // SF *************************************************************
            ...
            // ION PHYSICS*************************************************************
            hadronPhys.push_back(new G4IonElasticPhysics());  // Ion Elastic scattering
            hadronPhys.push_back( new G4IonPhysicsPHP()); // Ion Inelastic physics
            // *************************************************************************

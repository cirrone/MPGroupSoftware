...
#include "HadrontherapyStackingAction.hh" // SERENA
...
{       
 // Initialize the primary particles
  ...
  HadrontherapyStackingAction* pStackinAction = new HadrontherapyStackingAction();  // SERENA
  SetUserAction(pStackinAction);                                                    // SERENA

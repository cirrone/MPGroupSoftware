...
public:
  ...
  private:
    ...
    G4double                fVoxelWidthZ;

    G4double                fVoxelVolume;

    G4int                   fVoxelNumberAlongX;
    G4int                   fVoxelNumberAlongY;
    G4int                   fVoxelNumberAlongZ;

    G4int                   fTotalVoxelNumber;
    G4double                fVoxelMass;
    G4double                fVoxelDensity;

    // Voxelized objects
    G4Box* VoxelizedDetectorXDivision;
    G4Box* VoxelizedDetectorYDivision;
    G4Box* VoxelizedDetectorZDivision;

    G4LogicalVolume* VoxelizedDetectorXDivisionLog;
    G4LogicalVolume* VoxelizedDetectorYDivisionLog;
    G4LogicalVolume* VoxelizedDetectorZDivisionLog;
    G4LogicalVolume* sensitiveLogicalVolume;

    G4VPhysicalVolume *VoxelizedDetectorXDivisionPhys;
    G4VPhysicalVolume *VoxelizedDetectorYDivisionPhys;
    G4VPhysicalVolume *VoxelizedDetectorZDivisionPhys;
